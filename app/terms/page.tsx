      ...
      <main className="content-page">
        <div className="content-container">
          ...
          <div className="legal-content">
            <p className="legal-meta">Last updated: May 9, 2026</p>

            <div className="legal-section">
              <h3>AGREEMENT TO OUR LEGAL TERMS</h3>
              <p>
                We are BizYip ("Company," "we," "us," "our").
              </p>
              <p>
                We operate bizyip.com, as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
              </p>
              <p>
                You can contact us by email at <a href="mailto:thejacksegal@gmail.com" className="contact-email">thejacksegal@gmail.com</a>.
              </p>
              <p>
                These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and BizYip, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
              </p>
              <p>
            ...
            <div className="legal-section" id="ip">
              ...
              <p>
                If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:thejacksegal@gmail.com" className="contact-email">thejacksegal@gmail.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
              </p>
              <p>
            ...
            <div className="legal-section" id="userreps">
            ...
            <div className="legal-section" id="ugc">
            ...
            <div className="legal-section" id="sitemanage">
            ...
            <div className="legal-section" id="law">
              ...
              <p>
                These Legal Terms shall be governed by and defined following the laws of North Carolina, United States. BizYip and yourself irrevocably consent that the courts of North Carolina shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
              </p>
            </div>
            ...
            <div className="legal-section" id="disputes">
              ...
              <p>
                Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be 1. The seat, or legal place, or arbitration shall be Raleigh, North Carolina. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of North Carolina.
              </p>
            ...
            <div className="legal-section" id="corrections">
            ...
            <div className="legal-section" id="userdata">
              <h3>16. USER DATA</h3>
              <p>
            ...
            <div className="legal-section" id="electronic">
            ...
            <div className="legal-section" id="contact">
              ...
              <p>
                BizYip — <a href="mailto:thejacksegal@gmail.com" className="contact-email">thejacksegal@gmail.com</a> — Raleigh, North Carolina, United States
              </p>
            </div>
